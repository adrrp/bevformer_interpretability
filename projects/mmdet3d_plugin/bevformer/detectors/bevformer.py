...
class BEVFormer(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        #AFEGIT X MI X FORÇAR VIDEO TEST MODE (True, hi ha video, False, no hi ha video):   | Per defecte (execució normal test.py) està en True
        #video_test_mode = False
    ...
    def extract_img_feat(self, img, img_metas, len_queue=None):
        ...
        if img is not None:
            ...
            if img.dim() == 5 and img.size(0) == 1:
                #img.squeeze_()
                img = img.squeeze(0)  #AFEGIT X MI X EVITAR "RuntimeError: a leaf Variable that requires grad is being used in an in-place operation."
