...
def show_seg(labels, car_img):
    ...
    # Es necesario voltearlo horizontalmente aquí, porque eso es lo que asegura que es el mismo que en el sistema de coordenadas de la imagen, como es habitual #
