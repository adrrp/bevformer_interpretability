...
model = dict(
    ...
    img_backbone=dict(
        ...
        norm_eval=True,
        style='caffe',
        with_cp=False, # using checkpoint to save GPU memory  -> DESACTIVAT PERQUE SINO CAPTUM FALLA
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=True),              #CANVIAT WITH LABEL A TRUE PER TAL DE CALCULAR NDS PER FRAME A SALIENCY
...
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=8,                                                          #CANVIAT, ABANS ESTAVA A 4
    train=dict(
        type=dataset_type,
        data_root=data_root,
